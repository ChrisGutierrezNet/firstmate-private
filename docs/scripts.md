...
| `fm-quota-axi-lib.sh`    | Shared `quota-axi` compatibility floor for bootstrap and dispatch authentication     |
| `fm-auth-preflight.sh`   | Resolve one dispatch tuple's selected authentication surface and emit bounded evidence |
